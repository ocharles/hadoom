...
void main()
{
    ...
    gl_FragColor += texture2D(s_texture, v_blurTexCoords[ 0]) * 0.06136; //0.147308056121;
    gl_FragColor += texture2D(s_texture, v_blurTexCoords[ 1]) * 0.24477; //0.147308056121;
    gl_FragColor += texture2D(s_texture, v_texCoord         ) * 0.38774; //0.159576912161;
    gl_FragColor += texture2D(s_texture, v_blurTexCoords[ 2]) * 0.24477;  //0.147308056121;
    gl_FragColor += texture2D(s_texture, v_blurTexCoords[ 3]) * 0.06136;  //0.147308056121;
