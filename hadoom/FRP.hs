...
--------------------------------------------------------------------------------
newtype Wire m a b =
  Wire {stepWire :: Time -> a -> m (b,Wire m a b)}
